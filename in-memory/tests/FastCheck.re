...
external string: unit => generator(string) = "string";
[@bs.module "fast-check"]
external array: generator('a) => generator(array('a)) = "array";

[@bs.module "fast-check"]
external property: (generator('a), predicate('a)) => property = "property";
